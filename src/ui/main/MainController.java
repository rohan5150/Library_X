...
public class MainController implements Initializable, BookReturnCallback {
    ...
    void handleDragOver(MouseEvent event) {
        rootPane.getScene().getWindow().setX(event.getScreenX() - OffsetX);
    ...
    void handlemaximize(MouseEvent event) {
        ...
        if (!maxed) {
            getStage().setWidth(Screen.getPrimary().getVisualBounds().getMaxX());
    ...
    private void handleAboutMenu(ActionEvent event) {
        LibraryAssistantUtil.loadWindow(getClass().getResource("/ui/about/about.fxml"), "About Me", null);
    }
    ...
    @FXML
    public void handleDragOpacity(MouseEvent mouseEvent) {
